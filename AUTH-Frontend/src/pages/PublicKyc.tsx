...
import KycFormMaster1 from "../components/dashboard/user/KycFormMaster1";
...
const PublicKyc = () => {
  ...
  const handleVerified = async () => {
    ...
    try {
      ...
      console.warn(
        "External form unreachable, falling back to local form.",
        err
      );
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      {window.location.port === "3000" ? (
        ...
        <KycFormMaster1
          initialSessionId={sessionId ? sessionId.toString() : null}
