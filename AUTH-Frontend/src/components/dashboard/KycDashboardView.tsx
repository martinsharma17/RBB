...
interface KycDashboardViewProps {
    onViewChange?: (view: string, id?: number) => void;
}

const KycDashboardView: React.FC<KycDashboardViewProps> = ({ onViewChange }) => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">KYC Analytics Dashboard</h1>
                    <p className="text-gray-500">Real-time overview of KYC verification progress across your scope.</p>
                </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 rounded-2xl shadow-lg relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white/10 backdrop-blur-md p-3 rounded-xl border border-white/10">
                                    <div className="flex justify-between items-center mb-1">
                                        <span className="text-xs text-blue-100">Success Rate</span>
                                        <span className="bg-green-400 text-green-900 text-[10px] font-bold px-2 py-0.5 rounded-full">Good</span>
                                    </div>
                                    <div className="w-full bg-white/20 h-1.5 rounded-full overflow-hidden">
                                        <div
                                            className="bg-green-400 h-full transition-all duration-1000"
                                            style={{ width: `${Math.min(100, (stats.approved / (stats.totalSubmitted || 1)) * 100)}%` }}
                                        ></div>
                                    </div>
                                </div>
                            </div>
...
export default KycDashboardView;
