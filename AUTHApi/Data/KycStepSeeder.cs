        ...
        public static async Task SeedStepsAsync(ApplicationDbContext context)
        {
            ...
            var steps = new List<KycFormSteps>
            {
                new KycFormSteps
                {
                    ...
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 1
                },
                new KycFormSteps
                {
                    StepNumber = 2, StepName = "Current Address", StepNameNepali = "हालको ठेगाना",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 2
                },
                new KycFormSteps
                {
                    StepNumber = 3, StepName = "Permanent Address", StepNameNepali = "स्थायी ठेगाना",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 3
                },
                new KycFormSteps
                {
                    StepNumber = 4, StepName = "Family Members", StepNameNepali = "परिवारका सदस्यहरू",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 4
                },
                new KycFormSteps
                {
                    StepNumber = 5, StepName = "Bank Account", StepNameNepali = "बैंक खाता", TableName = "KycDetail",
                    IsRequired = true, DisplayOrder = 5
                },
                new KycFormSteps
                {
                    StepNumber = 6, StepName = "Occupation Details", StepNameNepali = "पेशागत विवरण",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 6
                },
                new KycFormSteps
                {
                    StepNumber = 7, StepName = "Financial Details", StepNameNepali = "आर्थिक विवरण",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 7
                },
                new KycFormSteps
                {
                    StepNumber = 8, StepName = "Transaction Information", StepNameNepali = "कारोबार विवरण",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 8
                },
                new KycFormSteps
                {
                    StepNumber = 9, StepName = "Guardian Details", StepNameNepali = "संरक्षकको विवरण",
                    TableName = "KycDetail", IsRequired = false, DisplayOrder = 9
                },
                new KycFormSteps
                {
                    StepNumber = 10, StepName = "AML Compliance", StepNameNepali = "सम्पत्ति शुद्धिकरण",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 10
                },
                new KycFormSteps
                {
                    StepNumber = 11, StepName = "Photo & Documents", StepNameNepali = "फोटो र कागजात",
                    TableName = "KycDocument", IsRequired = true, DisplayOrder = 11
                },
                new KycFormSteps
                {
                    StepNumber = 12, StepName = "Location Map", StepNameNepali = "स्थान नक्सा",
                    TableName = "KycDetail", IsRequired = true, DisplayOrder = 12
                },
                new KycFormSteps
                {
                    StepNumber = 13, StepName = "Declarations", StepNameNepali = "घोषणा", TableName = "KycDetail",
                    IsRequired = true, DisplayOrder = 13
                },
                new KycFormSteps
                {
                    StepNumber = 14, StepName = "Agreement", StepNameNepali = "सम्झौता", TableName = "KycDetail",
