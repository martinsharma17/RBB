...
namespace AUTHApi.Data
{
    public static class MenuSeeder
    {
        public static async Task SeedMenuItemsAsync(ApplicationDbContext context)
        {
            ...
            {
                Title = "Dashboard", ViewId = "dashboard", Icon = "DashboardIcon", Permission = "dashboard", Order = 1
            };
            var profileItem = new MenuItem
                { Title = "My Profile", ViewId = "user_profile", Icon = "UserIcon", Permission = null, Order = 2 };
            var usersItem = new MenuItem
            {
                Title = "User Management", ViewId = "users", Icon = "UsersIcon", Permission = Permissions.Users.Sidebar,
                Order = 3
            };
            var rolesItem = new MenuItem
            {
                Title = "Roles & Permissions", ViewId = "roles", Icon = "RolesIcon",
                Permission = Permissions.Roles.Sidebar, Order = 4
            };
            var policyItem = new MenuItem
            {
                Title = "Policy Editor", ViewId = "policies", Icon = "PolicyIcon",
                Permission = Permissions.Policies.Sidebar, Order = 5
            };

            var kycItem = new MenuItem
            {
                Title = "KYC Verification", ViewId = "kyc", Icon = "KycIcon", Permission = Permissions.Kyc.Sidebar,
                Order = 6
            };
            ...
            var chartsItem = new MenuItem
            {
                ...
                Permission = Permissions.Analytics.Sidebar, Order = 7
            };
            ...
            var projectsItem = new MenuItem
            {
                ...
                Permission = Permissions.Projects.Sidebar, Order = 7
            };
            var tasksItem = new MenuItem
            {
                Title = "Tasks", ViewId = "tasks", Icon = "TaskIcon", Permission = Permissions.Tasks.Sidebar, Order = 8
            };
            ...
            var items = new List<MenuItem>
            {
                ...
                new MenuItem
                {
                    ...
                    Permission = Permissions.Reports.Sidebar, Order = 9
                },
                new MenuItem
                {
                    Title = "Audit Logs", ViewId = "audit", Icon = "AuditIcon", Permission = Permissions.Audit.Sidebar,
                    Order = 10
                },
                new MenuItem
                {
                    Title = "Notifications", ViewId = "notifications", Icon = "NotificationsIcon",
                    Permission = Permissions.Notifications.Sidebar, Order = 11
                },
                new MenuItem
                {
                    Title = "Settings", ViewId = "settings", Icon = "SettingsIcon",
                    Permission = Permissions.Settings.Sidebar, Order = 12
                },
                new MenuItem
                {
                    Title = "Security", ViewId = "security", Icon = "SecurityIcon",
                    Permission = Permissions.Security.Sidebar, Order = 13
                },
                new MenuItem
                {
                    Title = "Backup & Restore", ViewId = "backup", Icon = "BackupIcon",
                    Permission = Permissions.Backup.Sidebar, Order = 14
                },
            };
            ...
            {
                Title = "My Projects", ViewId = "my_projects", Permission = Permissions.Projects.SidebarMyProjects,
            ...
            {
                Title = "Project Content", ViewId = "project_content", Permission = Permissions.Projects.SidebarContent,
            ...
            {
                Title = "Team & Workflow", ViewId = "project_team", Permission = Permissions.Projects.SidebarTeam,
            ...
            var projectSettings = new MenuItem
            {
                ...
                Permission = Permissions.Projects.SidebarSettings, Order = 1, ParentId = projectTeam.Id
            };
            ...
            {
                Title = "List", ViewId = "task_list", Permission = Permissions.Tasks.SidebarList, Order = 1,
                ParentId = tasksItem.Id
            };
            var taskKanban = new MenuItem
            {
                Title = "Kanban", ViewId = "task_kanban", Permission = Permissions.Tasks.SidebarKanban, Order = 2,
                ParentId = tasksItem.Id
            };
